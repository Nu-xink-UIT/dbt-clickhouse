...
SELECT
    ...
    product_name,
    currency_code,
    dictGet('silver.dict_vcb_rates', 'reference_price', currency_code) AS exchange_rate_to_vnd,
    dictGet('silver.dict_vcb_rates', 'event_time', currency_code) AS exchange_rate_time,
